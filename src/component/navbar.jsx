...
const Navbar = ({ user, handleLogout, toggleTheme }) => {
            ...
            <>
              ...
              <div className="relative">
                ...
                <div
                  onMouseEnter={() => setDropdownOpen(true)}
                  onMouseLeave={() => setDropdownOpen(false)}
                  className={`absolute right-0 top-12 bg-gray-800 border border-[#fdc800] p-3 rounded shadow-md w-56 z-50 transform transition-all duration-300 ${
